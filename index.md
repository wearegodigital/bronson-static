...
<div class="portfolio-items overflow-x-clip">
    {% include components/portfolio-tease.html 
        title="Absolut" slug="absolut" count=1 url="https://wearegodigital.github.io/bronson-static/portfolio" bg="#BE91F5"
    ...
    %}
    {% include components/portfolio-tease.html 
        title="ESPN" slug="espn" count=2 url="https://wearegodigital.github.io/bronson-static/portfolio" bg="#66B5C1"
    ...
    %}
    {% include components/portfolio-tease.html 
        title="Theragun" slug="theragun" count=3 url="https://wearegodigital.github.io/bronson-static/portfolio" bg="#A86BAC"
    ...
    %}
    {% include components/portfolio-tease.html 
        title="Sorel" slug="sorel" count=4 url="https://wearegodigital.github.io/bronson-static/portfolio" bg="#fd8b86"
    ...
    %}
    {% include components/portfolio-tease.html 
        title="Nylon x NBC" slug="nylon-nbc" count=5 url="https://wearegodigital.github.io/bronson-static/portfolio" bg="#c2e4fd"
    ...
    %}
    {% include components/portfolio-tease.html 
        title="MTV VMAs" slug="mtv-vmas" count=6 url="https://wearegodigital.github.io/bronson-static/portfolio" bg="#0027b9"
    ...
    %}
    {% include components/portfolio-tease.html 
        title="Airbnb x Pride" slug="airbnb" count=7 url="https://wearegodigital.github.io/bronson-static/portfolio" bg="#624fa1"
        layout=5 display="light" last_display="light" next_display="dark"
    ...
    %}
    {% include components/portfolio-tease.html 
        title="ALOK" slug="alok" count=8 url="https://wearegodigital.github.io/bronson-static/portfolio" bg="#B2C3B0"
    ...
    %}
    {% include components/portfolio-tease.html 
        title="Therabody" slug="therabody" count=9 url="https://wearegodigital.github.io/bronson-static/portfolio" bg="#efc84c"
    ...
    %}
    {% include components/portfolio-tease.html 
        title="Blink Fitness" slug="blink-fitness" count=10 url="https://wearegodigital.github.io/bronson-static/portfolio" bg="#FEBDA6"
    ...
    %}
    {% include components/portfolio-tease.html 
        title="Samsung" slug="samsung" count=11 url="https://wearegodigital.github.io/bronson-static/portfolio" bg="#0092df"
    ...
    %}
    {% include components/portfolio-tease.html 
        title="Bubly" slug="bubly" count=12 url="https://wearegodigital.github.io/bronson-static/portfolio" bg="#50c8ea"
    ...
    %}
    {% include components/portfolio-tease.html 
        title="Live Love Polish" slug="live-love-polish" count=13 url="https://wearegodigital.github.io/bronson-static/portfolio" bg="#cb8ae8"
    ...
    %}
    {% include components/portfolio-tease.html 
        title="J. Breckenridge" slug="j-breckenridge" count=14 url="https://wearegodigital.github.io/bronson-static/portfolio" bg="#febcd8"
    ...
    %}
    {% include components/portfolio-tease.html 
        title="Lucie Fink Media" slug="lucie-fink-media" count=15 url="https://wearegodigital.github.io/bronson-static/portfolio" bg="#ffbaa9"
    ...
    %}
    {% include components/portfolio-tease.html 
        title="PrEPVIIV Healthcare" slug="prepviiv-healthcare" count=16 url="https://wearegodigital.github.io/bronson-static/portfolio" bg="#e16b2a"
        layout=3 display="light" last_display="light" next_display="light"
    ...
    %}
    {% include components/portfolio-tease.html 
        title="Livinguard" slug="livinguard" count=17 url="https://wearegodigital.github.io/bronson-static/portfolio" bg="#91D1C7"
        layout=3 display="light" last_display="light" next_display="dark"
    ...
    %}
    {% include components/portfolio-tease.html 
        title="Dunkin'" slug="dunkin" count=18 url="https://wearegodigital.github.io/bronson-static/portfolio" bg="#f8e3c9"
